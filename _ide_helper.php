...
')
     ...
     */ 
        class LaravelFileViewerFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function show($filename, $filePath, $file_url, $file_data = [])
        {
                        /** @var \Vish4395\LaravelFileViewer\LaravelFileViewer $instance */
                        return $instance->show($filename, $filePath, $file_url, $file_data);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Vish4395\LaravelFileViewer\LaravelFileViewer $instance */
                        return $instance->getIconClass($type);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class LaravelFileViewer extends \Vish4395\LaravelFileViewer\LaravelFileViewerFacade {}
