    ...
    <div class="navbar navbar-light">
      <div class="container-fluid">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown {{ request()->segment(1) == 'indikatory-kvality' ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="top"
            data-bs-original-title="Indikátory kvality">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="" role="button"
              aria-expanded="false">
              <span class="nav-link-icon d-inline-block d-lg-inline-block d-lg-none d-xl-inline-block">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item {{ request()->segment(1) == 'adversevents' ? 'bg-primary-lt' : '' }}" data-bs-toggle="tooltip"
                ...
                <span class="nav-link-title">
                  {{ __('Nežádoucí události přehled') }}
                </span>
                <span class="badge badge-sm bg-muted-lt text-uppercase ms-auto">{{ App\Models\Adversevent::all()->count() }}</span>
              </a>
          ...
          <li class="nav-item dropdown {{ request()->segment(1) == 'porady' ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="top"
            data-bs-original-title="Zápisy z poradZápisy z porad">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="" role="button"
              aria-expanded="false">
              <span class="nav-link-icon d-inline-block d-lg-inline-block d-lg-none d-xl-inline-block">
            ...
            <div class="dropdown-menu">
              <div class="dropdown">
                <a class="dropdown-item{{ request()->segment(2) == 'radio' ? 'active' : '' }}" href="{{ route('media.radio') }}">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <svg class="icon text-orange" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                      stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div class="dropend">
                  <a class="dropdown-item dropdown-toggle show" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="#" role="button"
                    aria-expanded="true">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <svg class="icon text-pink" width="40" height="40" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
