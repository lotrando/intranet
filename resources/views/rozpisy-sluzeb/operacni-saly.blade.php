                          ...
                          <div class="col-12 col-lg-8 mb-2">
                            ...
                            <select class="form-select edit" name="interna[{{ $day->id }}]" data-id="{{ $day->id }}">
                              ...
                              @foreach ($doctorsJip as $doctor)
                                <option data-phone="{{ $doctor->mobile }}" value="{{ $doctor->title_preffix . ' ' . $doctor->last_name }}" @if (old('interna[' . $day->id . ']') == $doctor->title_preffix . ' ' . $doctor->last_name) selected @endif>
                        ...
                        @auth
                          <div class="col-12 col-lg-8 mb-2">
                            ...
                            <select class="form-select edit" name="interna[{{ $day->id }}]" data-id="{{ $day->id }}">
                              <option value="">Vyber lékaře</option>
                              @foreach ($doctorsJip as $doctor)
                                <option value="{{ $doctor->title_preffix . ' ' . $doctor->last_name }}" @if (old('interna[' . $day->id . ']') == $doctor->title_preffix . ' ' . $doctor->last_name) selected @endif date-phone="{{ $doctor->phone }}">
                                  {{ $doctor->title_preffix }} {{ $doctor->last_name }}
                                </option>
                              @endforeach
                            </select>
