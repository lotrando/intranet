    ...
    <div class="row">
      <div class="col-12">
        ...
        @foreach ($documents as $document)
          <div class="hr-text text-blue m-3 py-3">{{ substr($document[0]['name'], 0, 1) }}</div>
          <div>
                        ...
                        <div class="col text-truncate" id="{{ $item->id }}">
                          <span>
                            <p class="show d-inline text-primary text-decoration-none cursor-pointer" id="{{ $item->id }}" data-bs-toggle="tooltip"
                              data-bs-placement="top" data-bs-original-title="Více informací o dokumentu {{ $item->description }}" style="margin-bottom: 0;">
                              {{ $item->name }}
